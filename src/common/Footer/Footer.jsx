...
const Footer = () => {
  return (
    <div className="bg-blue-600 text-white">
      <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex items-center mt-6">
            ...
            >
              2023 <span className="font-semibold">সুরক্ষা</span>
            </Link>
      ...
      <h1 className="text-gray-100 top-t text-center py-2">
        © ২০২৩ । এই ব্লগে প্রকাশিত সকল পরামর্শ তথ্য মাত্র। এগুলো কোন ডাক্তারি
        পরামর্শ নয়। কোন টিপস অনুসরণ করার পূর্বে ডাক্তারের সাথে আলোচনা করুন।
        Privacy Policy
      </h1>
    </div>
  );
